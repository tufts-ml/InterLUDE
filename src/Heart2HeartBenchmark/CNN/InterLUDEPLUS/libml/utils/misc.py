...
def train_one_epoch(args, weights, paired_l_u_loader, model, ema_model, optimizer, scheduler, epoch, global_iteration_count, tau_t, p_t, label_hist, sat_criterion, saf_criterion):
